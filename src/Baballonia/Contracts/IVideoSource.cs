...
{
    /// <summary>Identity of the last returned image halves, in source order, never guessed.</summary>
    VideoFrameIdentity? LastFrameIdentity => null;
    bool Start();
    bool Stop();
...
public sealed record VideoFrameIdentity(long? LeftSequence, long? LeftReceiptTimestamp,
    long? RightSequence, long? RightReceiptTimestamp, bool Combined,
    bool LeftMirrored = false, bool RightMirrored = false);
